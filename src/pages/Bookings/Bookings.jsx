...
import BookingForm from '../../components/BookigForm/BookingForm';
                ...
                {loading ? (
                    ...
                    <>
                        <div className="content-general__path">
                            <GeneralPath path={"booking"} length={0} />
                        </div>
                        <div className="booking-details" style={{
                            marginRight: isVerticalNavClosed ? "120px" : "76px"
                        }}>
                            <BookingForm profile={loggedProfile} data={dataList} />
                            <BookingSummaryCard data={dataList}></BookingSummaryCard>
                        </div>
                    </>
                }
            </section>
